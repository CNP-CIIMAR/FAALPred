...
def generate_filtered_table_and_graphs(table1_path, table2_path, domain_name, taxonomic_level, top_n, dpi):
    ...
    print(f"Dados filtrados da Tabela 1 para o domínio {domain_name}:")
    ...
    print("Dados filtrados da Tabela 1 com valores de 'Assembly' começando com 'GCF' ou 'GCA':")
    print(df1_filtered.head())
    ...
    print("Dados da Tabela 1 após aplicação dos critérios de filtragem:")
    print(df1_filtered.head())
    ...
    print("Dados filtrados da Tabela 2 baseados nos grupos taxonômicos da Tabela 1:")
    print(df2_filtered.head(10))  # Mostrar mais linhas para depuração
