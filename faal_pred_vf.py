...
class Support:
  ...
  #      self.parameters = {
   #         "n_estimators": [150],  # Fixar em 100 por enquanto
    #        "max_depth": [5, 10],   # Testar algumas profundidades razoáveis
     #       "min_samples_split": [2,4],  # Limitar a busca
      #      "min_samples_leaf": [2,4],   # Evitar min_samples_leaf=1 que tende a overfitting
       #     "criterion": ["gini"],  # "gini" costuma ser mais rápido e também eficiente
        #    "max_features": ["sqrt"],  # "sqrt" é padrão e geralmente bom
        #   "class_weight": ["balanced"], # "balanced" ajuda se há desbalanceamento
         #   "max_leaf_nodes": [None, 10], # Testar sem limitação e com limitação moderada
          #  "min_impurity_decrease": [0.0], # Poucas opções
           # "bootstrap": [True],    # Geralmente True é padrão no RandomForest
            #"ccp_alpha": [0.0, 0.001]  # Testar pouca complexidade
       # }
...
class ProteinEmbeddingGenerator:
    ...
    def generate_embeddings(
        ...
        if os.path.exists(word2vec_model_full_path):
            ...
            model = Word2Vec(
                sentences=all_kmers,
                vector_size=390,  # Change to 100 if necessary ### Estava 400
