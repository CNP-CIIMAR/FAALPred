...
from sklearn.manifold import TSNE  # Import for t-SNE (to be removed)
...
class Support:
    ...
    # Classes com pelo menos 2 amostras ṣo selecionadas para oversampling
        classes_to_oversample = {cls: max(0, count) for cls, count in counter.items()}
...
def main(args):
    ...
    # Verify feature size before prediction
